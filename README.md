...
- **Image retrieval**:
  ...
  - `MeanAveragePrecisionAtK(k)`: computes [Mean Average Precision at k](https://stackoverflow.com/questions/54966320/mapk-computation), an information retrieval metric.
...
- **Image retrieval**: Recall@k, Precision@k, Precision-Recall Curve, Mean Average Precision at k
